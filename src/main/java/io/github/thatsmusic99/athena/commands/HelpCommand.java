...
public class HelpCommand implements IAthenaCommand {
    ...
    private final Component decoration = Component.text("                      ", TextColor.color(0x4EB4FF),
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command cmd, @NotNull String s,
        ...
        for (Subcommand subcommand : Subcommand.values()) {
            ...
            io.github.thatsmusic99.athena.commands.Command commandInfo =
                    subcommand.getExecutor().getClass().getAnnotation(io.github.thatsmusic99.athena.commands.Command.class);
    ...
    private Component commandEntry(CommandSender sender, io.github.thatsmusic99.athena.commands.Command commandInfo) {
        String prettyCommand = sender instanceof Player ? "/athena " + commandInfo.name() :
                "athena " + commandInfo.name();
        Component prettyCommandComponent = Component.text(prettyCommand, AthenaCore.getInfoColour());
        Component descriptionComponent = Component.text(" - " + commandInfo.description(),
